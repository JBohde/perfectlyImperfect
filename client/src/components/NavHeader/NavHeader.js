      ...
      <div id="nav-header">
        <div className="row navbar-header-content">
          <div className="col-12 col-sm-12 col-md-3 col-lg-3 navbar-social">
            <a
              href="https://www.facebook.com/perfectlyimperfectblogpage/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <img
                src="../assets/images/if_facebook_313485.png"
                className="social-img"
                alt="fb-logo"
              />
            </a>
            <a
              href="https://www.instagram.com/perf_imperf2017/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <img
                src="../assets/images/if_instagram_313477.png"
                className="social-img"
                alt="insta-logo"
              />
            </a>
            <a
              href="https://twitter.com/perf_imperf2017"
              target="_blank"
              rel="noopener noreferrer"
            >
              <img
                src="../assets/images/if_twitter_313466.png"
                className="social-img"
                alt="twitter-logo"
              />
            </a>
          ...
          <div className=" col-12 col-sm-12 col-md-3 col-lg-3 navbar-subscribe">
            <MyModal
              id="subscribe"
              openLabel="SUBSCRIBE"
              modalHeader="Subscribe to Perfectly Imperfect"
            />
          </div>
        </div>
        <hr />
